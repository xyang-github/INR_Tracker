...
"}")
        ...
        self.btnAdd_event = QtWidgets.QPushButton(self.widget)
        self.btnAdd_event.setMinimumSize(QtCore.QSize(75, 30))
        self.btnAdd_event.setIcon(icon)
        self.btnAdd_event.setObjectName("btnAdd_event")
        self.lytButtons_events.addWidget(self.btnAdd_event)
        self.btnEdit_event = QtWidgets.QPushButton(self.widget)
        self.btnEdit_event.setMinimumSize(QtCore.QSize(75, 30))
        self.btnEdit_event.setIcon(icon1)
        self.btnEdit_event.setAutoDefault(False)
        self.btnEdit_event.setObjectName("btnEdit_event")
        self.lytButtons_events.addWidget(self.btnEdit_event)
        self.btnDelete_event = QtWidgets.QPushButton(self.widget)
        self.btnDelete_event.setMinimumSize(QtCore.QSize(75, 30))
        self.btnDelete_event.setIcon(icon2)
        self.btnDelete_event.setObjectName("btnDelete_event")
        self.lytButtons_events.addWidget(self.btnDelete_event)
        ...
        DlgProfile.setTabOrder(self.tblResult, self.btnAdd)
        DlgProfile.setTabOrder(self.btnAdd, self.btnDelete)
    ...
    def retranslateUi(self, DlgProfile):
        ...
        item.setText(_translate("DlgProfile", "Comment"))
        self.btnAdd_event.setText(_translate("DlgProfile", "Add"))
        self.btnEdit_event.setText(_translate("DlgProfile", "Edit"))
        self.btnDelete_event.setText(_translate("DlgProfile", "Delete"))
