...
"}")
        ...
        self.layoutWidget1.setGeometry(QtCore.QRect(30, 450, 621, 31))
        ...
        sizePolicy.setHeightForWidth(self.btnEditPatient.sizePolicy().hasHeightForWidth())
        self.btnEditPatient.setSizePolicy(sizePolicy)
        self.btnEditPatient.setMinimumSize(QtCore.QSize(85, 25))
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/img/icon/edit.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btnEditPatient.setIcon(icon)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.btnAnalytics.sizePolicy().hasHeightForWidth())
        self.btnAnalytics.setSizePolicy(sizePolicy)
        self.btnAnalytics.setMinimumSize(QtCore.QSize(85, 25))
        ...
        self.btnPDF.setMinimumSize(QtCore.QSize(85, 25))
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/img/icon/export.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.btnCSV.sizePolicy().hasHeightForWidth())
        self.btnCSV.setSizePolicy(sizePolicy)
        self.btnCSV.setMinimumSize(QtCore.QSize(85, 25))
        self.btnCSV.setIcon(icon1)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.btnExitProfile.sizePolicy().hasHeightForWidth())
        self.btnExitProfile.setSizePolicy(sizePolicy)
        self.btnExitProfile.setMinimumSize(QtCore.QSize(85, 25))
        self.btnExitProfile.setObjectName("btnExitProfile")
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/img/icon/add.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btnAddResult.setIcon(icon2)
        ...
        self.btnEditResult.setIcon(icon)
        self.btnEditResult.setAutoDefault(False)
        self.btnEditResult.setObjectName("btnEditResult")
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/img/icon/delete.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btnDeleteResult.setIcon(icon3)
        self.btnDeleteResult.setObjectName("btnDeleteResult")
        ...
        self.layoutWidget2 = QtWidgets.QWidget(self.Events)
        self.layoutWidget2.setGeometry(QtCore.QRect(10, 50, 671, 421))
        self.layoutWidget2.setObjectName("layoutWidget2")
        self.lytMain = QtWidgets.QHBoxLayout(self.layoutWidget2)
        self.lytMain.setContentsMargins(0, 0, 0, 0)
        self.lytMain.setObjectName("lytMain")
        self.tblEvents = QtWidgets.QTableWidget(self.layoutWidget2)
        ...
        self.btnDeleteEvent = QtWidgets.QPushButton(self.layoutWidget2)
        self.btnDeleteEvent.setMinimumSize(QtCore.QSize(75, 30))
        self.btnDeleteEvent.setIcon(icon3)
