...
class Ui_dlgMain(object):
    def setupUi(self, dlgMain):
        ...
        self.btnSearchPatient.setObjectName("btnSearch")
        ...
        self.menuExit.setObjectName("actionExit")
        self.menuHelpDialog = QtWidgets.QAction(dlgMain)
        self.menuHelpDialog.setObjectName("actionINR_Tracker_Help")
        self.menuNewPatient = QtWidgets.QAction(dlgMain)
        self.menuNewPatient.setObjectName("actionAdd_New_Patient")
        self.menuFile.addAction(self.menuNewPatient)
